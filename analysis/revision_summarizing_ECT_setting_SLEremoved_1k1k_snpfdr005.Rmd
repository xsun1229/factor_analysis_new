---
title: "Summarizing ECT results -- ≥ 5 supporting SNPs (FDR < 0.05) & ≥ 20 genes, Onek1k, "
author: "XSun"
date: "2025-12-09"
output:
...
<!-- | celltype       |  factor   |  pathwayName                                    |  trait_id                    |  trait_name                  |  num_supp_SNP |  p_ECT   |  ECT_FDR_5suppSNP | Pathway effects on cell type                                                                                                                                                | Pathway effects on trait                                                                                                                                                                                                                     | cell type effects on trait                                                                                                                                                                                                                                                                                       | -->
<!-- |----------------|-----------|-------------------------------------------------|------------------------------|------------------------------|---------------|----------|-------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| -->
...
# Plots for all pairs at ECT FDR < 0.2
...
#for (i in 1:1){
for (i in 1:nrow(df_all_fdr02)){

  celltype <- celltypes[df_all_fdr02$celltype[i]]
  trait <- df_all_fdr02$trait_id[i]
