...
If we corrected the ACAT p-values within each cell type (pool all ACAT p-values in each trait), we have: 
...
# Corrected ACAT p-values for each trait (global null, MHC removed)
...
# Corrected ACAT p-values for each trait (trait null, MHC removed)

## B cell

```{r fig.height=25,fig.width=25}

load("/project/xinhe/xsun/pathway_factor/analysis/2.ACAT/results/B_cell_corrected_trait_acat_mhcexcluded.rdata")
...
load("/project/xinhe/xsun/pathway_factor/analysis/2.ACAT/results/CD14_positive_monocyte_corrected_trait_acat_mhcexcluded.rdata")
...
load("/project/xinhe/xsun/pathway_factor/analysis/2.ACAT/results/CD15_positive_leukocyte_corrected_trait_acat_mhcexcluded.rdata")
...
load("/project/xinhe/xsun/pathway_factor/analysis/2.ACAT/results/platelet_corrected_trait_acat_mhcexcluded.rdata")
...
load("/project/xinhe/xsun/pathway_factor/analysis/2.ACAT/results/T_cell_corrected_trait_acat_mhcexcluded.rdata")
...
load("/project/xinhe/xsun/pathway_factor/analysis/2.ACAT/results/thymocyte_corrected_trait_acat_mhcexcluded.rdata")
...
## Corrected p-values -- trait null -- MHC included


```{r} 

load("/project/xinhe/xsun/pathway_factor/analysis/2.ACAT/results/story_corrected_trait_acat.rdata")
...
## Corrected p-values -- trait null - MHC removed 


```{r} 

load("/project/xinhe/xsun/pathway_factor/analysis/2.ACAT/results/story_corrected_trait_acat_mhcexcluded.rdata")
...
## Corrected p-values -- pair null -- MHC included


```{r} 

load("/project/xinhe/xsun/pathway_factor/analysis/2.ACAT/results/story_corrected_pair_acat.rdata")
...
## Corrected p-values -- pair null - MHC removed 


```{r} 

load("/project/xinhe/xsun/pathway_factor/analysis/2.ACAT/results/story_corrected_pair_acat_mhcexcluded.rdata")
