...
for (celltype in celltypes) {
  acat_p_all[[celltype]] <- get(load(paste0("/project/xinhe/xsun/pathway_factor/analysis/2.ACAT/results/",celltype,"_corrected_acat_pool_celltype_mhcexcluded.rdata")))
}
...
for (trait in traits) {
  ...
  for (celltype in celltypes) {
    ...
    p_trait <- acat_p_all[[celltype]][[trait]]
    p[[celltype]] <- qqplot(p_trait,title = type[celltype])
  }
   
  grid.arrange(grobs = p, ncol = 6, nrow = 1,top = trait)
}
...
acat_p_all <- list()
for (celltype in celltypes) {
  acat_p_all[[celltype]] <- get(load(paste0("/project/xinhe/xsun/pathway_factor/analysis/2.ACAT/results/",celltype,"_corrected_trait_acat_mhcexcluded.rdata")))
}
