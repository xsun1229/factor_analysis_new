---
title: "Effect Size Consistency Tests (SNP FDR < 0.2, FDR corrected, corrected ACAT FDR < 0.2)"
author: "XSun"
date: "2022-11-30"
...
2. For the pairs have multiple snps (>=3) passing FDR < 0.2 && corrected ACAT FDR < 0.2, do ECT
...
for (i in 1:length(path)){
  ...
  load(paste0(folder_path,"results/ECT_summary_table_corrected_acat_filtered_fdr02.rdata"))
...
for (i in 1:length(type)){ 
  ...
  file_ect_summary <- paste0("/project2/xinhe/xsun/CEDAR/",path[i],"/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_corrected_acat_filtered_fdr02.rdata")
