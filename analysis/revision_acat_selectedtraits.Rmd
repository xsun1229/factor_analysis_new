...
acat_celltype$celltype <- type[acat_celltype$celltype]
acat_celltype <- acat_celltype %>%
  mutate(PathwayID = sub("_.*", "", factor)) %>%
  left_join(pathway_df, by = c("PathwayID" = "ID"))

acat_celltype <- acat_celltype[, c("celltype", "trait", "factor","name",
                                   setdiff(names(acat_celltype), c("celltype", "trait","factor","name","PathwayID")))]
acat_celltype <- acat_celltype[order(acat_celltype$acat_p_correct_noMHC_traitnull),]
acat_celltype <- acat_celltype[complete.cases(acat_celltype$acat_p_correct_noMHC_traitnull),]
