---
title: "ECT -- pathways with gene >=20"
author: "XSun"
date: "2025-09-21"
output:
...
for (i in 1:length(celltypes)) {
  ...
  file_ect <- paste0(folder_ect,celltypes[i],"_ECT_summary_table_numsnp3.rdata")
...
load("/project/xinhe/xsun/pathway_factor/analysis/1.ECT/results_20genes/ECT_story.rdata")
...
load("/project/xinhe/xsun/pathway_factor/analysis/1.ECT/results_20genes/summary_mbe_steiger.rdata")
...
```{r message=FALSE,warning=F, fig.height=35, fig.width=25}
load("/project/xinhe/xsun/pathway_factor/analysis/1.ECT/results_20genes/summary_mbe_steiger.rdata")

df_sorted <- df_all[order(as.numeric(df_all$fdr_ECT), decreasing = F),]
df_sorted <- df_sorted[df_sorted$fdr_ECT < 0.1,]

B_cell <- get(load("/project/xinhe/xsun/pathway_factor/analysis/1.ECT/assoc_20genes/harmo_addinfo/B_cell_harmo.rdata"))
CD14_positive_monocyte <- get(load("/project/xinhe/xsun/pathway_factor/analysis/1.ECT/assoc_20genes/harmo_addinfo/CD14_positive_monocyte_harmo.rdata"))
platelet <- get(load("/project/xinhe/xsun/pathway_factor/analysis/1.ECT/assoc_20genes/harmo_addinfo/platelet_harmo.rdata"))
T_cell <- get(load("/project/xinhe/xsun/pathway_factor/analysis/1.ECT/assoc_20genes/harmo_addinfo/T_cell_harmo.rdata"))

harmo <- list(B_cell,CD14_positive_monocyte,platelet,T_cell)
names(harmo) <- c("B_cell","CD14_positive_monocyte","platelet","T_cell")
...
```{r message=FALSE,warning=F, fig.height=8, fig.width=20}
index <- which(df_all$trait %in%c("EUR.IBD","EUR.CD","EUR.UC","ukb.allasthma"))
...
load("/project/xinhe/xsun/pathway_factor/analysis/1.ECT/results_20genes/compare_snp_filtered.rdata")
...
load("/project/xinhe/xsun/pathway_factor/analysis/1.ECT/results_20genes/harmo_reverse.rdata")
