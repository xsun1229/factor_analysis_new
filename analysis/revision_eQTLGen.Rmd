...
For each trait, we extracted the SNPs with p-value < 5E-8, then use the collected SNPs as the pool for random SNP, sampled 10*245 SNPs from it, use them as the random SNPs
...
# If supporting SNPs are trans-eqtls, comparing with totally random SNPs
