...
df_long <- df_long %>%
  mutate(num_suppSNP = factor(num_suppSNP, levels = sort(unique(num_suppSNP))))

ggplot(df_long, aes(x = celltype, y = as.numeric(num_pairs), fill = num_suppSNP)) +
...
https://uchicago.box.com/s/ich3y70feolfz98yf4pe3h1ltxs24171 
