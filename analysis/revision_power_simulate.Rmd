...
file_power <- paste0("/project/xinhe/xsun/pathway_factor/analysis/1.ECT_v2/power_res/simulation/", celltype,"-", factor, "-", trait,"_downsample_",downsample_size,"_simulated.RDS")

res <- readRDS(file_power)
ECT_res_allround_df <- do.call(rbind, res)
