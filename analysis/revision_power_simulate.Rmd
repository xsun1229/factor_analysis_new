...
for (downsample_size in c(0.01, 0.1, 0.3, 0.5, 0.7, 1)){
  ...
  p[[as.character(downsample_size)]] <- ggplot(ECT_res_allround_df, aes(x = -log10(p_ECT))) +
    ...
    annotate(
      ...
      hjust = 1, vjust = 1.2,
      label = paste0(
        "Count p ≤ FDR 0.1 cutoff: ", num_leq_fdr01, "\n",
        "Count p ≤ FDR 0.2 cutoff: ", num_leq_fdr02
      ),
      size = 4,
      fill = "white",
      label.size = 0.3
...
## Not highlighted but ECT FDR < 0.2 example 1: B_cell - RBC-ebi-a-GCST90002403 - 04217_PC4
...
## Not highlighted but ECT FDR < 0.2 example 1: B_cell - RBC-ebi-a-GCST90002403 - 03040_PC4
