...
for(celltype in celltypes){
  ...
  df <- readRDS(paste0("/project/xinhe/xsun/pathway_factor/analysis/1.ECT_v2/ECT_summary_binAF/", celltype,"_ECT_summary_poolalltraits_selected.RDS"))
...
for (perm in c(1:10)){
  ...
  for(celltype in celltypes){
    ...
    df <- readRDS(paste0("/project/xinhe/xsun/pathway_factor/analysis/1.ECT_CEDAR_permu/ECT_summary_bin/perm", perm, "/", celltype,"_ECT_summary_poolalltraits_selected.RDS"))
