---
title: "Effect Size Consistency Tests (SNP FDR < 0.2, FDR corrected, Fisher FDR < 0.2)"
author: "XSun"
date: "2022-12-01"
...
for (i in 1:length(path)){
  ...
  load(paste0(folder_path,"results/ECT_summary_table_fisher_filtered_fdr02.rdata"))
...
for (i in 1:6){ 
  ...
  file_ect_summary <- paste0("/project2/xinhe/xsun/CEDAR/",path[i],"/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_fisher_filtered_fdr02.rdata")
